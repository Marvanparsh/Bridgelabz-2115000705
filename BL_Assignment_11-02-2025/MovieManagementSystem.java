    ...
    public void searchByDirectorOrRating(String director, double rating) {
        ...
        while (temp != null) {
            if (temp.director.equalsIgnoreCase(director) || temp.rating == rating) {
                System.out.println(temp.title + " directed by " + temp.director + ", Year: " + temp.year + ", Rating: " + temp.rating);
                found = true;
            }
            temp = temp.next;
        }
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6: movieList.displayForward(); break;
                case 7: movieList.displayReverse(); break;
                case 8:
