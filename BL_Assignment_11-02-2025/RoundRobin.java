        ...
        while (processesRemaining) {
            ...
            for (int i = 0; i < totalProcesses; i++) {
                if (remainingBurstTimes[i] > 0) {
                    ...
                    System.out.println("Process " + current.processId + " executing for " + timeSlice + " units.");
                    ...
                    if (remainingBurstTimes[i] == 0) {
                        ...
                        System.out.println("Process " + current.processId + " completed. Turnaround Time: " + current.turnaroundTime + ", Waiting Time: " + current.waitingTime);
                    }
