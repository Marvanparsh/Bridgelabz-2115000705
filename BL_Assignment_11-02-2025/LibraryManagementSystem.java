    ...
    public void searchByTitle(String title) {
        ...
        while (temp != null) {
            if (temp.title.equalsIgnoreCase(title)) {
                System.out.println("Book Found: ID=" + temp.bookId + ", Title=" + temp.title + ", Author=" + temp.author + ", Genre=" + temp.genre + ", Available=" + temp.isAvailable);
                return;
            }
            temp = temp.next;
        }
    ...
    public void searchByAuthor(String author) {
        ...
        while (temp != null) {
            if (temp.author.equalsIgnoreCase(author)) {
                System.out.println("Book Found: ID=" + temp.bookId + ", Title=" + temp.title + ", Genre=" + temp.genre + ", Available=" + temp.isAvailable);
            }
            temp = temp.next;
        }
    }
